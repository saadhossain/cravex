...
const order_item_option_entity_1 = require("./order-item-option.entity");
const order_entity_1 = require("./order.entity");
let OrderItem = class OrderItem extends auditable_entity_1.Auditable {
    menuItemName;
    quantity;
    unitPrice;
    totalPrice;
...
__decorate([
    (0, typeorm_1.OneToMany)(() => order_item_option_entity_1.OrderItemOption, (option) => option.orderItem, {
        cascade: true,
    }),
